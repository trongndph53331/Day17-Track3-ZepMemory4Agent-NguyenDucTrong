...
- Average retrieval latency: **706.9 ms**
- Average token reduction vs full source context: **14.2%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.1 | 133 | 0.0% |  |
| E06 | semantic | PASS | 451.9 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1656.6 | 814 | 0.0% |  |
| E10 | short_term | PASS | 0.2 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1135.6 | 1408 | 0.0% |  |
| E03 | long_term | PASS | 1134.7 | 1418 | 0.0% |  |
| E04 | episodic | PASS | 219.3 | 233 | 0.0% |  |
| E05 | episodic | PASS | 221.0 | 252 | 0.0% |  |
| E07 | mixed | PASS | 1535.7 | 485 | 14.2% |  |
| E11 | semantic | PASS | 280.5 | 146 | 74.2% |  |
| E08 | long_term | PASS | 1140.7 | 1388 | 0.0% |  |
...
`<USER_SUMMARY> Lan's project is LOTUS-88. They prioritize Java and Spring Boot, and do not use Python for backend examples.  Lan prioritizes Java and Spring Boot for backend development and avoids using Python in this context. </USER_SUMMARY>  <EPISODES> Episodes are source message or document excerpts shown in selection order.   - Created At: 2026-08-01 11:00:20     Source: message     Content: Lab Assistant (assistant): Da hieu: LOTUS-88, Java + Spring Boot cho backend examples.   - Created At: 2026-08-01 11:00:00     Source: message     Content: [user] {   "user_id": "lan-lab17",   "first_name": "Lan",   "last_name": "Tran",   "user_alias": "Lan Tran" }: Toi la Lan. Du an cua toi la LOTUS`
...
`<USER_SUMMARY> For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used. The user's personal project ORCHID-27 continues to use Python. The user was debugging async HTTP and attempted to increase the timeout to 60s, which failed. The effective solution involved reusing the aiohttp ClientSession and setting concurrency to 20, addressing connection churn related to the ASYNC-FIX-20 incident.  Minh Nguyen prefers Python and dislikes Java. When explaining code, Minh prefers concise examples. The user's assistant will prioritize timelines when explaining coroutine and Task. The user prefers Python for personal demos like ORCHID-27. </USER_SUMM`
...
`<LONG_TERM> <USER_SUMMARY> For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used. The user's personal project ORCHID-27 continues to use Python. The user was debugging async HTTP and attempted to increase the timeout to 60s, which failed. The effective solution involved reusing the aiohttp ClientSession and setting concurrency to 20, addressing connection churn related to the ASYNC-FIX-20 incident.  Minh Nguyen prefers Python and dislikes Java. When explaining code, Minh prefers concise examples. The user's assistant will prioritize timelines when explaining coroutine and Task. The user prefers Python for personal demos like ORCHID-27.`
